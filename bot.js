...
client.on('ready', () => {
  console.log(`Logged in as ${client.user.tag}!`);
	client.user.setGame(`Shelp|ShaherArmy .`,'https://www.twitch.tv/v5bz');
});
  ...
  client.on("guildMemberAdd", member => {
    ...
    return channel.send(`**Welcome To ShaherArmy** :beers: 
    **Enjoy** :beers: 
[ ${member} ]`) 
  }).catch(console.error)
  })
...
client.on("ready", () => {
    var guild;
    while (!guild)
        guild = client.guilds.get("539219669383643472")
...
});//The code created by @! - ᴱˣShaherAhly2005#2199
